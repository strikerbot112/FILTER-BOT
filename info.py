...
API_ID = int(environ.get('API_ID', '23953322'))
API_HASH = environ.get('API_HASH', '7d234185304b6143d556136d8aa3d635')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2126596218').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002635673566'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002726166342').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002735055687') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4879761409')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002467206165').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shiyonsobygaming:xly9fMK0Ptfh9dvL@cluster0.esp4v0r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+M8cTd0pUX3JlZmVl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Ymdb02W-SUIyYmY1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+zfqAChiqzLM0ZWQ9') # Support Chat Link Without https:// or @
